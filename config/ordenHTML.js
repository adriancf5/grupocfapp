...
module.exports.HTML = function (valores, partidas, imagen, user) {
    ...
    cHtml += "<div class='Fila'><img src='Imagenes/icon-ios7-cart-outline.svg'  class='img1'/></div><strong>Refacciones y/o Servicios</strong>"
    ...
    cHtml += "<P>En Ezequiel Montes,Qro el dia: " + dateformat(valores.Fecha_ing) + ", " + valores.ClienteDir
    cHtml += "<p>Términos y Condiciones</p>"
    cHtml += "<div class='Terminos'>"
    cHtml += "<ol class='auto-style2'>"
    ...
    cHtml += "<ol class='auto-style2' start='9'>"
    cHtml += "<li>No hay devolución o cancelación en refacciones y/o productos sobre pedido.</li>"
 		cHtml += "<li>La garantía de refacciones y/o equipos está estipulada por cada fabricante o proveedor y será notificada al cliente. La garantía en mano de obra es de 30 días, y solo aplica a componentes. No hay garantía en servicios de software, sistemas operativos y/o antivirus.</li>"
    cHtml += "<li>No respondemos por equipos abandonados después de 30 días, y se cobrará $25.00 MN diarios de almacenaje de equipo, y deberá de ser liquidado en su totalidad al retirar el equipo. Equipos abandonados por más de 60 días serán donados a instituciones públicas o privadas para su aprovechamiento.</li>"
    ...
    cHtml += "<P>En Ezequiel Montes,Qro el dia: " + dateformat(valores.Fecha_ing) + ", " + valores.Contacto
    cHtml += "<p>Términos y Condiciones</p>"
    cHtml += "<div class='Terminos'>"
    cHtml += "<ol class='auto-style2'>"
    cHtml += "<li>Toda revisión del equipo causa un cargo mínimo de $150.00 MN, excepto servidores, workstations, impresión de volumen (copiadoras, impresoras y/o multifuncionales), plotters, impresoras doble carta que tienen un cargo mínimo de $600.00.</li>"
    ...
    cHtml += "</div>"
    cHtml += " <div class='Terminos' aria-disabled='True'>"
    cHtml += "<ol class='auto-style2' start='7'>"
    cHtml += "<li>No hay devolución o cancelación en refacciones y/o productos sobre pedido.</li>"
 		cHtml += "<li>La garantía de refacciones y/o equipos está estipulada por cada fabricante o proveedor y será notificada al cliente. La garantía en mano de obra es de 30 días, y solo aplica a componentes. No hay garantía en servicios de software, sistemas operativos y/o antivirus.</li>"
    cHtml += "<li>No respondemos por equipos abandonados después de 30 días, y se cobrará $25.00 MN diarios de almacenaje de equipo, y deberá de ser liquidado en su totalidad al retirar el equipo. Equipos abandonados por más de 60 días serán donados a instituciones públicas o privadas para su aprovechamiento.</li>"
    cHtml += "<li>Cualquier restauración o evento de software, tiene como cargo mínimo $120.00, excepto servidores.</li>"
    ...
    cHtml += "</div>"
    cHtml += "<div class='cerrar'><img src='Imagenes/icon-close.svg' /></div></div>"

    cHtml += "<div style='margin-top:300px; text-align:center; width:90%' >"
    cHtml += "<H3> Puede consultar su ORDEN DE SERVICIO en la siguiente pagina: </h3>"
    cHtml += "<h1><strong><u> GRUPOCFAPP.COM/SERVICIO </u></strong><h1>"

    var cliente = valores.ClienteNom.split(' ')
    var nombre = cliente[0].split('')
    var apellido = cliente[1].split('')
    cHtml += "<h1>  Su contraseña es: " + nombre[0] + nombre[1] + apellido[0] + valores.Serie + valores.id + "</h1>"
    cHtml += "</div>"
