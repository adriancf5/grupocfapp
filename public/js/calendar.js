...
(function($) {
	...
	Calendar.prototype.view = function(view) {
        if (view) {
            this.options.events_source = empleado() + '';
	...
	Calendar.prototype._update_month = function() {
		...
		$('a.event').mouseenter(function() {
			$('a[data-event-id="' + $(this).data('event-id') + '" data-get="' + $(this).data('event-dataget') + '"]').closest('.cal-cell1').addClass('day-highlight dh-' + $(this).data('event-class'));
		});
	...
	function showEventsList(event, that, slider, self) {
		...
		setTimeout(function() {
			$('a.event-item').mouseenter(function() {
				$('a[data-event-id="' + $(this).data('event-id') + '" data-get="'+ $(this).data('dataget') +'"]').closest('.cal-cell1').addClass('day-highlight dh-' + $(this).data('event-class'));
			});
