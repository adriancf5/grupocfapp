	...
	'use strict';
	 ...
	 App = {
		...
		deviceError: function (error) {
			...
			console.error('Ha ocurrido un error : [CODE ' + error.code + ']');
		},
		...
		getSnapshot: function () {
            ...
            if (App.options.context === 'webrtc') {
                ...
                var container = document.getElementById('imagesN')
                var canvas = document.createElement('canvas');
                canvas.width = video.videoWidth;
                canvas.height = video.videoHeight;
                canvas.id = 'canvas';
                canvas.setAttribute('name', 'fotos');
                canvas.setAttribute('value', '')
