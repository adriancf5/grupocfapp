...
;(function (window, document) {
    ...
    window.getUserMedia = function (options, successCallback, errorCallback) {
        ...
        if (options !== undefined) {
            ...
            navigator.getUserMedia_ = (navigator.mediaDevices.getUserMedia || navigator.webkitGetUserMedia || navigator.mediaDevices.mozGetUserMedia || navigator.msGetUserMedia);
            ...
            if ( !! navigator.getUserMedia_) {
                ...
                try {
                    ...
                    navigator.getUserMedia_(options_object, successCallback, errorCallback);
